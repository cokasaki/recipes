...
'Sauces':['Honey Mustard Sauce','Coconut Lime Sauce','Thai Peanut Sauce','Teriyaki Sauce','Mustardy BBQ Sauce','Sweet BBQ Sauce 2','Sweet BBQ Sauce','Sweet n Sour Sauce'],
'Drinks':['Mango Lassi']
};
var savedRecipes = [];
var savedRecipeIDs = [];
